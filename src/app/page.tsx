...
<div className="absolute inset-0 bg-purple-900 opacity-60 z-[-2]" />
<div className="absolute inset-0 bg-[url('/fog.png')] bg-cover opacity-90 animate-fadeFog z-[-1] pointer-events-none" />
